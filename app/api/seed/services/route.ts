...
const categories = [
  ...
  },
  {
    name: 'Plumbing & Water',
    slug: 'plumbing-water',
    description: 'Professional plumbing and water repair services',
    icon: '🔧',
    displayOrder: 3
  },
  {
  ...
  },
  {
    name: 'Software & IT',
    slug: 'software-it',
    description: 'Computer and IT repair services',
    icon: '💻',
    displayOrder: 6
  },
  {
...
const services = [
  ...
  // Construction & Renovation (5 services)
  ...
  // Events & Celebrations (5 services)
